...
const chartData = {
  series: [70, 50, 30, 24],
  labels: ['NCBA BANK', 'EQUITY BANK', 'NATIONAL BANK', 'KCB BANK']
}
...
<template>
  ...
  >
    <div class="mb-3 justify-between gap-10 sm:flex">
      <div>
        <h4 class="text-xl font-bold text-black dark:text-white">Banks Investment</h4>
      </div>
      <div>
