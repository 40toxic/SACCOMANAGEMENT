<template>
    ...
    >
      ...
      <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        ...
        <div class="mt-4">
          <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">Regina Maina</h3>
          <p class="font-medium">SACCO Client </p>
          <div
          ...
          >
            ...
            >
              <span class="font-semibold text-black dark:text-white">8000</span>
              <span class="text-sm">Investment Balance</span>
            </div>
            <div
              class="flex flex-col items-center justify-center gap-1 border-r border-stroke px-3 dark:border-strokedark xsm:flex-row"
            >
              <span class="font-semibold text-black dark:text-white">12900k</span>
